...
Route::get('/{admin}/pesanan', fn () => view('pages.admin.pesanan'));
Route::get('/{admin}/produk', fn () => view('pages.admin.pesanan'));
Route::get('/{admin}/riwayat', fn () => view('pages.admin.pesanan'));